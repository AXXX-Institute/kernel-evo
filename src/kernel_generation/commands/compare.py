...
from kernel_generation.core.program.compare import (
    EvalConfig,
    EvalSummary,
    run_compare,
)
...
def setup_parser(subparsers: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument("--problem-dir", default="", help="Path to kernel_generation (repo root)")
...
def compare(args: argparse.Namespace) -> None:
    ...
    if args.problem_dir and str(args.problem_dir).strip():
        ...
        problem_dir = Path(__file__).resolve().parents[2]
