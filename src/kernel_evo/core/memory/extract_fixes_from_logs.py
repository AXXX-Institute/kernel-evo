...
def parse_log_file(file_path: str, include_context: bool = False):
    ...
    try:
        ...
        out = {"kernelbench_results": {}, "exception_json": {}, "program_code": ""}
        if include_context:
            out["context"] = {}
        return out
...
if __name__ == "__main__":
    directory = "/home/sivtsov/kernel_evo/outputs_bestruns/validate_logs"
    # directory = "/home/sivtsov/kernel_evo/outputs/validate_logs"
    # directory = "/home/sivtsov/kernel_evo/outputs2/validate_logs"
